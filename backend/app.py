...
from api.routes.schedules import (
    ...
    register_schedule_exception_routes,
)
...
# Инициализация и запуск воркера (ПРАВИЛЬНЫЙ ВАРИАНТ)
notification_worker = NotificationWorker(
    notification_service.check_and_send_notifications, check_interval=30
)
